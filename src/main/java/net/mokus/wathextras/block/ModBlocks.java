...
public class ModBlocks {
    ...
    public static final Block CANDELABRE = registerBlock("candelabre",
            new CandelabreBlock(ParticleTypes.SMALL_FLAME,
                    BlockBehaviour.Properties.of().instabreak().lightLevel(CandelabreBlock.STATE_TO_LUMINANCE).
                            sounds(SoundType.WOOD).pushReaction(PushReaction.DESTROY)));
    public static final Block WALL_CANDELABRE = registerBlock("wall_candelabre",
            new WallCandelabreBlock(ParticleTypes.SMALL_FLAME,
                    BlockBehaviour.Properties.of().instabreak().lightLevel(WallCandelabreBlock.STATE_TO_LUMINANCE).
                            sounds(SoundType.WOOD).pushReaction(PushReaction.DESTROY).dropsLike(ModBlocks.CANDELABRE)));
    ...
    public static final Block BLEACHED_STAIRS = registerBlock("bleached_stairs",
            new StairsBlock(ModBlocks.BLEACHED_PLANKS.getDefaultState(), BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS)));
    ...
    public static final Block BLEACHED_PANEL = registerBlock("bleached_panel",
            new PanelBlock(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS)));
    ...
    public static final Block VERAWOOD_STAIRS = registerBlock("verawood_stairs",
            new StairsBlock(ModBlocks.VERAWOOD_PLANKS.getDefaultState(), BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS)));
    ...
    public static final Block KHAKI_RIVETED_HULL_SMALL = registerBlock("khaki_riveted_hull_small",
            new Block(BlockBehaviour.Properties.copy(WatheBridgerBlocks.DARK_STEEL)));
    public static final Block KHAKI_RIVETED_HULL_SMALL_SLAB = registerBlock("khaki_riveted_hull_small_slab",
            new SlabBlock(BlockBehaviour.Properties.copy(WatheBridgerBlocks.DARK_STEEL)));
    public static final Block KHAKI_RIVETED_HULL_SMALL_STAIRS = registerBlock("khaki_riveted_hull_small_stairs",
            new StairsBlock(ModBlocks.KHAKI_RIVETED_HULL_SMALL.getDefaultState(),BlockBehaviour.Properties.copy(WatheBridgerBlocks.DARK_STEEL)));
    public static final  Block KHAKI_RIVETED_HULL_SMALL_WALL = registerBlock("khaki_riveted_hull_small_wall",
            new WallBlock(BlockBehaviour.Properties.copy(WatheBridgerBlocks.DARK_STEEL)));
    public static final  Block KHAKI_RIVETED_HULL_SMALL_PANEL = registerBlock("khaki_riveted_hull_small_panel",
            new PanelBlock(BlockBehaviour.Properties.copy(WatheBridgerBlocks.DARK_STEEL)));
    ...
    public static final Block ANTHRACITE_RIVETED_HULL_SMALL_STAIRS = registerBlock("anthracite_riveted_hull_small_stairs",
            new StairsBlock(ModBlocks.ANTHRACITE_RIVETED_HULL_SMALL.getDefaultState(),BlockBehaviour.Properties.copy(WatheBridgerBlocks.DARK_STEEL)));
    ...
    public static final Block BLACK_RIVETED_HULL_SMALL_STAIRS = registerBlock("black_riveted_hull_small_stairs",
            new StairsBlock(ModBlocks.BLACK_RIVETED_HULL_SMALL.getDefaultState(),BlockBehaviour.Properties.copy(WatheBridgerBlocks.DARK_STEEL)));
    ...
    public static final Block MAROON_RIVETED_HULL_SMALL_STAIRS = registerBlock("maroon_riveted_hull_small_stairs",
            new StairsBlock(ModBlocks.MAROON_RIVETED_HULL_SMALL.getDefaultState(),BlockBehaviour.Properties.copy(WatheBridgerBlocks.DARK_STEEL)));
    ...
    public static final Block MUNTZ_RIVETED_HULL_SMALL_STAIRS = registerBlock("muntz_riveted_hull_small_stairs",
            new StairsBlock(ModBlocks.MUNTZ_RIVETED_HULL_SMALL.getDefaultState(),BlockBehaviour.Properties.copy(WatheBridgerBlocks.DARK_STEEL)));
    ...
    public static final Block NAVY_RIVETED_HULL_SMALL_STAIRS = registerBlock("navy_riveted_hull_small_stairs",
            new StairsBlock(ModBlocks.NAVY_RIVETED_HULL_SMALL.getDefaultState(),BlockBehaviour.Properties.copy(WatheBridgerBlocks.DARK_STEEL)));
    ...
    public static final Block WHITE_RIVETED_HULL_SMALL_STAIRS = registerBlock("white_riveted_hull_small_stairs",
            new StairsBlock(ModBlocks.WHITE_RIVETED_HULL_SMALL.getDefaultState(),BlockBehaviour.Properties.copy(WatheBridgerBlocks.DARK_STEEL)));
    ...
    public static final Block BLACK_MOQUETTE = registerBlock("black_moquette",
            new Block(BlockBehaviour.Properties.copy(Blocks.BLACK_WOOL).strength(-1.0f,3600000.0f)));
    public static final Block CYAN_MOQUETTE = registerBlock("cyan_moquette",
            new Block(BlockBehaviour.Properties.copy(Blocks.CYAN_WOOL).strength(-1.0f,3600000.0f)));
    public static final Block GRAY_MOQUETTE = registerBlock("gray_moquette",
            new Block(BlockBehaviour.Properties.copy(Blocks.GRAY_WOOL).strength(-1.0f,3600000.0f)));
    public static final Block GREEN_MOQUETTE = registerBlock("green_moquette",
            new Block(BlockBehaviour.Properties.copy(Blocks.GREEN_WOOL).strength(-1.0f,3600000.0f)));
    public static final Block LIGHT_BLUE_MOQUETTE = registerBlock("light_blue_moquette",
            new Block(BlockBehaviour.Properties.copy(Blocks.LIGHT_BLUE_WOOL).strength(-1.0f,3600000.0f)));
    public static final Block LIGHT_GRAY_MOQUETTE = registerBlock("light_gray_moquette",
            new Block(BlockBehaviour.Properties.copy(Blocks.LIGHT_GRAY_WOOL).strength(-1.0f,3600000.0f)));
    public static final Block LIME_MOQUETTE = registerBlock("lime_moquette",
            new Block(BlockBehaviour.Properties.copy(Blocks.LIME_WOOL).strength(-1.0f,3600000.0f)));
    public static final Block MAGENTA_MOQUETTE = registerBlock("magenta_moquette",
            new Block(BlockBehaviour.Properties.copy(Blocks.MAGENTA_WOOL).strength(-1.0f,3600000.0f)));
    public static final Block ORANGE_MOQUETTE = registerBlock("orange_moquette",
            new Block(BlockBehaviour.Properties.copy(Blocks.ORANGE_WOOL).strength(-1.0f,3600000.0f)));
    public static final Block PINK_MOQUETTE = registerBlock("pink_moquette",
            new Block(BlockBehaviour.Properties.copy(Blocks.PINK_WOOL).strength(-1.0f,3600000.0f)));
    public static final Block PURPLE_MOQUETTE = registerBlock("purple_moquette",
            new Block(BlockBehaviour.Properties.copy(Blocks.PURPLE_WOOL).strength(-1.0f,3600000.0f)));
    public static final Block WHITE_MOQUETTE = registerBlock("white_moquette",
            new Block(BlockBehaviour.Properties.copy(Blocks.WHITE_WOOL).strength(-1.0f,3600000.0f)));
    public static final Block YELLOW_MOQUETTE = registerBlock("yellow_moquette",
            new Block(BlockBehaviour.Properties.copy(Blocks.YELLOW_WOOL).strength(-1.0f,3600000.0f)));

    // Start Carpets
    public static final Block BLACK_MOQUETTE_CARPET = registerBlock("black_moquette_carpet",
            new CarpetBlock(BlockBehaviour.Properties.copy(Blocks.BLACK_CARPET).strength(-1.0f,3600000.0f)));
    public static final Block CYAN_MOQUETTE_CARPET = registerBlock("cyan_moquette_carpet",
            new CarpetBlock(BlockBehaviour.Properties.copy(Blocks.CYAN_CARPET).strength(-1.0f,3600000.0f)));
    public static final Block GRAY_MOQUETTE_CARPET = registerBlock("gray_moquette_carpet",
            new CarpetBlock(BlockBehaviour.Properties.copy(Blocks.GRAY_CARPET).strength(-1.0f,3600000.0f)));
    public static final Block GREEN_MOQUETTE_CARPET = registerBlock("green_moquette_carpet",
            new CarpetBlock(BlockBehaviour.Properties.copy(Blocks.GREEN_CARPET).strength(-1.0f,3600000.0f)));
    public static final Block LIGHT_BLUE_MOQUETTE_CARPET = registerBlock("light_blue_moquette_carpet",
            new CarpetBlock(BlockBehaviour.Properties.copy(Blocks.LIGHT_BLUE_CARPET).strength(-1.0f,3600000.0f)));
    public static final Block LIGHT_GRAY_MOQUETTE_CARPET = registerBlock("light_gray_moquette_carpet",
            new CarpetBlock(BlockBehaviour.Properties.copy(Blocks.LIGHT_GRAY_CARPET).strength(-1.0f,3600000.0f)));
    public static final Block LIME_MOQUETTE_CARPET = registerBlock("lime_moquette_carpet",
            new CarpetBlock(BlockBehaviour.Properties.copy(Blocks.LIME_CARPET).strength(-1.0f,3600000.0f)));
    public static final Block MAGENTA_MOQUETTE_CARPET = registerBlock("magenta_moquette_carpet",
            new CarpetBlock(BlockBehaviour.Properties.copy(Blocks.MAGENTA_CARPET).strength(-1.0f,3600000.0f)));
    public static final Block ORANGE_MOQUETTE_CARPET = registerBlock("orange_moquette_carpet",
            new CarpetBlock(BlockBehaviour.Properties.copy(Blocks.ORANGE_CARPET).strength(-1.0f,3600000.0f)));
    public static final Block PINK_MOQUETTE_CARPET = registerBlock("pink_moquette_carpet",
            new CarpetBlock(BlockBehaviour.Properties.copy(Blocks.PINK_CARPET).strength(-1.0f,3600000.0f)));
    public static final Block PURPLE_MOQUETTE_CARPET = registerBlock("purple_moquette_carpet",
            new CarpetBlock(BlockBehaviour.Properties.copy(Blocks.PURPLE_CARPET).strength(-1.0f,3600000.0f)));
    public static final Block WHITE_MOQUETTE_CARPET = registerBlock("white_moquette_carpet",
            new CarpetBlock(BlockBehaviour.Properties.copy(Blocks.WHITE_CARPET).strength(-1.0f,3600000.0f)));
    public static final Block YELLOW_MOQUETTE_CARPET = registerBlock("yellow_moquette_carpet",
            new CarpetBlock(BlockBehaviour.Properties.copy(Blocks.YELLOW_CARPET).strength(-1.0f,3600000.0f)));
    ...
    public static final Block DARK_MARBLE_TILE = registerBlock("dark_marble_tile",
            new Block(BlockBehaviour.Properties.copy(Blocks.QUARTZ_BRICKS).strength(-1.0f,3600000.0f)));
    ...
    public static final Block NORA_PLUSH = registerBlock("nora_plush",
            new PlushBlock(ModSounds.NORA_PLUSH,BlockBehaviour.Properties.copy(Blocks.RED_WOOL).noOcclusion()));
    public static final Block DAVIDANDROCKET_PLUSH = registerBlock("davidandrocket_plush",
            new PlushBlock(ModSounds.DAVIDANDROCKET_PLUSH,BlockBehaviour.Properties.copy(Blocks.ORANGE_WOOL).noOcclusion()));
    public static final Block DUCKAMOLY_PLUSH = registerBlock("duckamoly_plush",
            new PlushBlock(ModSounds.DUCKAMOLY_PLUSH,BlockBehaviour.Properties.copy(Blocks.WHITE_WOOL).noOcclusion()));
    public static final Block PICKLE_PLUSH = registerBlock("pickle_plush",
            new PlushBlock(ModSounds.PICKLE_PLUSH,BlockBehaviour.Properties.copy(Blocks.PURPLE_WOOL).noOcclusion()));
    public static final Block VERID__PLUSH = registerBlock("verid__plush",
            new PlushBlock(ModSounds.VERID__PLUSH,BlockBehaviour.Properties.copy(Blocks.WHITE_WOOL).noOcclusion()));
    public static final Block WILLO_PLUSH = registerBlock("willo_plush",
            new PlushBlock(ModSounds.WILLO_PLUSH,BlockBehaviour.Properties.copy(Blocks.WHITE_WOOL).noOcclusion()));
    public static final Block MOKUS_PLUSH = registerBlock("mokus_plush",
            new PlushBlock(ModSounds.DEFAULT_PLUSH,BlockBehaviour.Properties.copy(Blocks.BLACK_WOOL).noOcclusion()));
    public static final Block DOOGEY_PLUSH = registerBlock("doogey_plush",
            new PlushBlock(ModSounds.DOOGEY_PLUSH,BlockBehaviour.Properties.copy(Blocks.WHITE_WOOL).noOcclusion()));
    public static final Block SQUID_PLUSH = registerBlock("squid_plush",
            new PlushBlock(ModSounds.SQUID_PLUSH,BlockBehaviour.Properties.copy(Blocks.WHITE_WOOL).noOcclusion()));
    public static final Block PENCIL_PLUSH = registerBlock("pencil_plush",
            new PlushBlock(ModSounds.PENCIL_PLUSH,BlockBehaviour.Properties.copy(Blocks.WHITE_WOOL).noOcclusion()));
    public static final Block INDIGO_PLUSH = registerBlock("indigo_plush",
            new PlushBlock(ModSounds.INDIGO_PLUSH,BlockBehaviour.Properties.copy(Blocks.WHITE_WOOL).noOcclusion()));

    // Candy Cane
    public static final Block CANDY_CANE_BLOCK = registerBlock("candy_cane_block",
            new PillarBlock(BlockBehaviour.Properties.copy(Blocks.BONE_BLOCK)));
    ...
    public static final Block ANTHRACITE_RIVETED_HULL = registerBlock("anthracite_riveted_hull",
            new DoubleHullBlock(BlockBehaviour.Properties.copy(WatheBridgerBlocks.DARK_STEEL)));
    ...
    public static final Block STACK_LIGHTS = registerBlock("stack_lights",
            new StackLightBlock(BlockBehaviour.Properties.copy(Blocks.COPPER_BULB).lightLevel(StackLightBlock.STATE_TO_LUMINANCE)));

    public static final Block ROOF_LAMP = registerBlock("roof_lamp",
            new RoofLampBlock(BlockBehaviour.Properties.copy(Blocks.COPPER_BULB).lightLevel(StackLightBlock.STATE_TO_LUMINANCE)));
    ...
    public static final Block POLISHED_FORTERRA = registerBlock("polished_forterra",
            new Block(BlockBehaviour.Properties.copy(Blocks.MUD_BRICK_WALL)));
    ...
    public static final Block BLEACHED_WALL_PANEL = registerBlock("bleached_wall_panel",
            new WallPanelBlock(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS)));
    ...
    public static final Block CORRUGATED_DARK_STEEL_STAIRS = registerBlock("corrugated_dark_steel_stairs",
            new StairsBlock(ModBlocks.CORRUGATED_DARK_STEEL.getDefaultState(),BlockBehaviour.Properties.copy(WatheBridgerBlocks.DARK_STEEL)));
    ...
    public static final Block CORRUGATED_STAINLESS_STEEL_STAIRS = registerBlock("corrugated_stainless_steel_stairs",
            new StairsBlock(ModBlocks.CORRUGATED_STAINLESS_STEEL.getDefaultState(),BlockBehaviour.Properties.copy(WatheBridgerBlocks.DARK_STEEL)));
    ...
    public static final Block PERFORATED_STAINLESS_STEEL_STAIRS = registerBlock("perforated_stainless_steel_stairs",
            new StairsBlock(ModBlocks.PERFORATED_STAINLESS_STEEL.getDefaultState(),BlockBehaviour.Properties.copy(WatheBridgerBlocks.DARK_STEEL)));
    ...
    public static final Block PERFORATED_DARK_STEEL_STAIRS = registerBlock("perforated_dark_steel_stairs",
            new StairsBlock(ModBlocks.PERFORATED_DARK_STEEL.getDefaultState(),BlockBehaviour.Properties.copy(WatheBridgerBlocks.DARK_STEEL)));
    ...
    public static final Block BUTTERFLY_DOOR_BLOCK = registerBlock("butterfly_door",
            new ButterflyDoorBlock(BlockBehaviour.Properties.copy(WatheBridgerBlocks.DARK_STEEL).noOcclusion()));

    public static final Block KILL_BLOCK_PANEL = registerBlock("kill_block_panel",
            new KillBlockPanel(BlockBehaviour.Properties.copy(WatheBridgerBlocks.BARRIER_PANEL)));
    public static final Block KILL_BLOCK = registerBlock("kill_block",
            new KillBlock(BlockBehaviour.Properties.copy(Blocks.STONE).noOcclusion()));

    public static final Block SERVICE_BELL = registerBlock("service_bell",
            new SmallBellBlock(ModSounds.SERVICE_BELL,BlockBehaviour.Properties.copy(WatheBridgerBlocks.DARK_STEEL).noOcclusion()));

    public static final Block DARK_STEEL_ORNAMENT = registerBlock("dark_steel_ornament",
            new OrnamentBlock(BlockBehaviour.Properties.copy(WatheBridgerBlocks.GOLD_ORNAMENT)));
    ...
    public static final Block CHRISTMAS_LIGHTS = registerBlock("christmas_lights",
            new ChristmasLights(BlockBehaviour.Properties.copy(Blocks.VINE).sound(SoundType.COPPER_BULB).noOcclusion()));

    public static final Block WREATH = registerBlock("wreath",
            new WreathBlock(BlockBehaviour.Properties.copy(Blocks.VINE).sound(SoundType.AZALEA_LEAVES).noOcclusion()));
